...
const maxSafeNum = Number.MAX_SAFE_INTEGER // Обращение к стартическому свойству
...
const myArrTwo = Array.from(myArr); // Обращение к стартическому свойству для создания массива
